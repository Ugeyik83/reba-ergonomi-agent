...
REBA Ergonomi Risk Analiz Sistemi v5.1
Tüm hesaplama: reba_core.py | Tüm görsel: reba_visual.py
"""
...
from reba_visual import overlay_ciz, pdf_olustur
...
# ════════════════════════════════════════════════════════
# CSS — AÇIK TEMA / KURUMSAL / MOBİL UYUMLU
# ════════════════════════════════════════════════════════
...
/* Ana içerik — mobilde tam genişlik */
...
/* Metrik kutuları — mobilde 2x2 grid */
.metric-row {
    display: grid;
...
.info-box {
    ...
    padding: 9px 13px; font-size: 12px; color: #1e40af; margin: 6px 0;
}
.warn-box {
    background: #fffbeb; border: 1px solid #fde68a;
    border-left: 3px solid #d97706; border-radius: 6px;
    padding: 9px 13px; font-size: 12px; color: #92400e; margin: 6px 0;
}
.error-box {
    background: #fef2f2; border: 1px solid #fecaca;
    border-left: 3px solid #dc2626; border-radius: 6px;
    padding: 9px 13px; font-size: 12px; color: #991b1b; margin: 6px 0;
}

/* Mobil: büyük dokunmatik buton */
.stButton > button {
    font-family: 'IBM Plex Sans', sans-serif !important;
    font-weight: 600 !important;
    border-radius: 6px !important;
    min-height: 44px !important;   /* dokunmatik minimum */
...
<div class="app-header">
    ...
    <div>
        ...
        <p>Rapid Entire Body Assessment &nbsp;·&nbsp; Çoklu Fotoğraf &nbsp;·&nbsp;
           AI Postür Analizi &nbsp;·&nbsp; v5.1</p>
    </div>
</div>
""", unsafe_allow_html=True)

# ════════════════════════════════════════════════════════
# SIDEBAR — FORM & PARAMETRELER
# ════════════════════════════════════════════════════════
...
if calistir and form_tamam:
            ...
            for seg_ad, seg_val, seg_max, seg_aci in segs:
                ...
                <div class="seg-bar-wrap">
                    <div class="seg-bar-label">
                        ...
                        <span style="font-weight:700;color:{bc};
                                     font-family:'IBM Plex Mono',monospace">
                            {seg_val}/{seg_max}
                        </span>
                    </div>
                    <div class="seg-bar-track">
                        <div class="seg-bar-fill"
                             style="width:{pct*100:.0f}%;background:{bc}"></div>
                    </div>
                </div>
                """, unsafe_allow_html=True)
    ...
    form_bilgi = {
        ...
        'tutma':         tutma_val,
        'tutma_label':   tutma_label,
        'aktivite':      aktivite_val,
        'aktivite_aciklama': akt_aciklama_str,
    }
